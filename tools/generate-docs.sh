...
then
	...
	cd master || exit 1
		./haproxy-dconv.py -i ../haproxy/1.4-dev/doc/configuration.txt -o ../gh-pages/configuration-1.4.html
	cd $PROJECT_HOME
fi
...
then
	...
	cd master || exit 1
		./haproxy-dconv.py -i ../haproxy/1.5-dev/doc/configuration.txt -o ../gh-pages/configuration-1.5.html
	cd $PROJECT_HOME
fi
